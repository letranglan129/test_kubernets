...
using CartItem = API.Cart.Models.Cart;
...
namespace API.Cart.Controllers
{
    ...
    public class CartsController : ControllerBase
    {
        ...
        public CartsController(MS_CartDB context)
        {
            _context = context;
        }
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutCart(int id, CartItem cart)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<CartItem>> PostCart(CartItem cart)
        {
